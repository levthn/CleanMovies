...
class HomeScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        dissolve.add(subscribe) //Feedback:კი ჩააგდე კომპოზიტში მარა მერე? ფრამგენიტს ვიუ ტუ განადგურდა და ეს საბსცრიბშენებაი მაინც დაგრჩება, ამიტომ უნდა dissolve გაასუფთაო როცა ვიუ კვდება.
